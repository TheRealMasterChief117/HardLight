...
public sealed class PsionicAbilitiesSystem : EntitySystem
{
    ...
    private void InnatePowerStartup(EntityUid uid, InnatePsionicPowersComponent comp, MapInitEvent args)
    {
        ...
        {
            if (_prototypeManager.TryIndex<Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.PsionicPowerPrototype>(protoId, out var proto))
            {
    ...
    public void AddRandomPsionicPower(EntityUid uid, bool forced = false)
    {
        ...
        {
            if (!_prototypeManager.TryIndex<Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.PsionicPowerPrototype>(weight.Key, out var copyPower)
    ...
    ///     Initializes a new Psionic Power on a given entity, assuming the entity does not already have said power initialized.
    /// </summary>
    public void InitializePsionicPower(EntityUid uid, Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.PsionicPowerPrototype proto, bool playFeedback = true)
    {
        EnsureComp<PsionicComponent>(uid, out var psionic);
    ...
    public void RemovePsionicPower(EntityUid uid, PsionicComponent psionicComponent, Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.PsionicPowerPrototype psionicPower, bool forced = false)
    {
    ...
    public void RemovePsionicPower(EntityUid uid, Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.Content.Shared.Abilities.Psionics.PsionicPowerPrototype psionicPower, bool forced = false)
    {
